...
const String appId = "8ec06a098203409793cac708d5ae8e80";
...
class _StreamingPageState extends State<StreamingPage> {
  ...
  String token = "007eJxTYJi5+8d+mWa+POmGXo4/3Ld9Vsle/aulbVDz9kRcr3vOd3cFBovUZAOzRANLCyMDYxMDS3NL4+TEZHMDixTTxFSLVAuDzevfJjcEMjIkiDgzMzJAIIjPzuCbmlqSmZfOwAAApC4gOw==";
                    ...
                    child: Visibility(
                      ...
                      child: FloatingActionButton.extended(
                        ...
                        onPressed: () => {
                          setState((){
                            _isMute = !_isMute;
                            agoraEngine.muteLocalAudioStream(_isMute);
                          })
                        }, label: Text(""),
                      ),
                    ),
                  ...
                  Expanded(
                    child: Visibility(
                      ...
                      child: FloatingActionButton.extended(
                        ...
                        onPressed: () => {
                          setState((){
                            _isWebcamOff = !_isWebcamOff;
                            agoraEngine.muteLocalVideoStream(_isWebcamOff);
                          })
                        },
                      ),
                    ),
